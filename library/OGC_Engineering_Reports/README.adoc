...
* http://https://github.com/opengeospatial/Space-Standards-DWG/blob/development/library/OGC_Engineering_Reports/22-016r3_T18_D020_Moving_Features_ER.pdf[Moving Features ER]
